...
// Package ext_external_memory_host provides bindings for the VK_EXT_external_memory_host extension.
// Author: EXT
...
//
// RESOLVED:
// Applications have to use the new vkGetMemoryHostPointerPropertiesEXT
...
//
// 4) Is vkMapMemory expected to return the same host address which was
...
// particular handle type as returned in VkExternalMemoryProperties.
//
// Version History:
//
