...
// Init resolves and initializes all VK_EXT_extended_dynamic_state3 extension procedure addresses, setting default globals and returning a Commands instance for multi-device support.
