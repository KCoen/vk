...
// Package ext_tooling_info provides bindings for the VK_EXT_tooling_info extension.
// Author: EXT
...
//
// pToolProperties = (VkPhysicalDeviceToolPropertiesEXT)calloc(num_tools, sizeof(pToolProperties));
// for (int i = 0; i < num_tools; ++i)
//
//	pToolProperties[i].sType = VKSTRUCTURETYPEPHYSICALDEVICETOOLPROPERTIES_EXT;
//
...
//	    printf("Purposes:\n");
//	    printf("\t%s\n", VkToolPurposeFlagBitsEXTtostring(pToolProperties[i].purposes));
//	    if (strlen(pToolProperties[i].layer) > 0) {
//	        printf("Corresponding Layer:\n");
//	        printf("\t%s\n", pToolProperties[i].layer);
//	    }
//	}
//
// free(pToolProperties);
// ```
//
// Issues:
//
