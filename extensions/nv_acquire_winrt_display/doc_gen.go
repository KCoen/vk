...
// Package nv_acquire_winrt_display provides bindings for the VK_NV_acquire_winrt_display extension.
// Author: NV
...
//
// 2) Should vkAcquireWinrtDisplayNV take a winRT DisplayTarget, or a
...
//
// 4) Should the vkGetWinrtDisplayNV parameter identifying a display be
...
//
// 5) Does vkAcquireWinrtDisplayNV cause the Windows desktop compositor
// to release a display?
//
// RESOLVED:
// vkAcquireWinrtDisplayNV does not itself cause the Windows desktop
