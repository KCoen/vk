...
// Package qcom_render_pass_shader_resolve provides bindings for the VK_QCOM_render_pass_shader_resolve extension.
// Author: QCOM
...
// Issues:
//
// 1) Should this extension be named renderpassshader_resolve?
//
// RESOLVED Yes.
//
// This is part of suite of small extensions to render pass.
//
// Following the style guide, instead of following VKKHRcreate_renderpass2.
//
// 2) Should the VKSAMPLECOUNT1BIT be required for each pColorAttachment
...
// chain.
//
// 4) Do we need the VKSUBPASSDESCRIPTIONFRAGMENTREGIONBITQCOM bit?
//
// RESOLVED Yes.
//
...
//   - Change resolution of Issue 1 (renderpass, not renderpass_)
