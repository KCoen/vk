...
// Package ext_private_data provides bindings for the VK_EXT_private_data extension.
// Author: NV
...
// Issues:
//
// (1) If I have to create a VkPrivateDataSlot to store and retrieve data
// on an object, how does this extension help me? Will I not need to store the
// VkPrivateDataSlot mapping with each object, and if I am doing that, I
// might as well just store the original data!
//
// The VkPrivateDataSlot can be thought of as an opaque index into
// storage that is reserved in each object.
// That is, you can use the same VkPrivateDataSlot with each object for a
// specific piece of information.
// For example, if a layer wishes to track per-object information, the layer
// only needs to allocate one VkPrivateDataSlot per device and it can use
