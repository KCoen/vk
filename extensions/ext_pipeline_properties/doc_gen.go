...
// Package ext_pipeline_properties provides bindings for the VK_EXT_pipeline_properties extension.
// Author: EXT
...
// VkPipelinePropertiesIdentifierEXT structure, but that could be relaxed
