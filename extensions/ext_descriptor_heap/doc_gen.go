...
// Package ext_descriptor_heap provides bindings for the VK_EXT_descriptor_heap extension.
// Author: EXT
...
//   - VKKHRshaderuntypedpointers must be supported, but it does not
