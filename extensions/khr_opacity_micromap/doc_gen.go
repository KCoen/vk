...
// Package khr_opacity_micromap provides bindings for the VK_KHR_opacity_micromap extension.
// Author: KHR
...
//   - This extension provides API support for
//     {GLSLregistry}/ext/GLSLEXTopacitymicromaprayquerymode.txt[GLSLEXTopacitymicromaprayquerymode]
//
// Contributors:
...
//   - Contributors to VKEXTopacity_micromap
//
// Description:
//
...
//
//   - the ability to create micromaps as VkAccelerationStructureKHR
//     structures
...
//     VKEXTopacity_micromap and provides significantly different
//     functionality.
//
// (6) Should micromaps API be similar to the VKEXTopacity_micromap?
// VKEXTopacity_micromap introduced almost an identical set of
...
//
// (8) Should vkCreateAccelerationStructureKHR be used to create
// micromaps?
// This interface that uses VkBuffer to back micromaps is deprecated, but
...
//
// (9) Should
// VKBUILDACCELERATIONSTRUCTUREALLOWOPACITYMICROMAPDATAUPDATEBITEXT
// be promoted from VKEXTopacity_micromap to this extension?
// VKBUILDACCELERATIONSTRUCTUREALLOWOPACITYMICROMAPDATAUPDATEBITEXT
// distinguished between replacing a micromap with one of a different shape
// (VKBUILDACCELERATIONSTRUCTUREALLOWOPACITYMICROMAPUPDATEBIT_EXT)
