...
// Package ext_pageable_device_local_memory provides bindings for the VK_EXT_pageable_device_local_memory extension.
// Author: EXT
...
// accordingly.
// The extension also exposes a new vkSetDeviceMemoryPriorityEXT function
...
// VkPhysicalDevicePageableDeviceLocalMemoryFeaturesEXT::pname:pageableDeviceLocalMemory
// feature enabled.
...
// return VKERROROUTOFDEVICE_MEMORY even if device-local memory appears to
