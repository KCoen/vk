...
// Package nv_shading_rate_image provides bindings for the VK_NV_shading_rate_image extension.
// Author: NV
...
//     {GLSLregistry}/nv/GLSLNVshadingrateimage.txt[GLNVshadingrateimage]
//
// Contributors:
//   - Pat Brown, NVIDIA
...
// {spirv}/NV/SPVNVshadingrate.html[SPVNVshadingrate] extension to
// SPIR-V.
...
// GLNVshadingrateimage language extension and correspond to the built-in
// variables glFragmentSizeNV and glInvocationsPerPixelNV,
// respectively.
//
// Issues:
//
...
// VKPIPELINESTAGESHADINGRATEIMAGEBIT_NV, should we specify a
...
// stage>> (VKPIPELINESTAGEGEOMETRYSHADER_BIT) and before the first
// stage used for fragment processing
// (VKPIPELINESTAGEEARLYFRAGMENTTESTSBIT), which seems to be the
