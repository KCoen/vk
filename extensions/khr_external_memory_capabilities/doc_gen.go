...
// Package khr_external_memory_capabilities provides bindings for the VK_KHR_external_memory_capabilities extension.
// Author: KHR
...
//
// 2) Do the VkExternalImageFormatPropertiesKHR and
// VkExternalBufferPropertiesKHR structs need to include a list of memory
...
// and vkGetBufferMemoryRequirements when a set of handle types was
