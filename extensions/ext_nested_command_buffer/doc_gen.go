...
// Package ext_nested_command_buffer provides bindings for the VK_EXT_nested_command_buffer extension.
// Author: EXT
...
// Description:
//
// With core Vulkan it is not legal to call vkCmdExecuteCommands when
