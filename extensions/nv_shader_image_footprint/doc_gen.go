...
// Package nv_shader_image_footprint provides bindings for the VK_NV_shader_image_footprint extension.
// Author: NV
...
//     {GLSLregistry}/nv/GLSLNVshadertexturefootprint.txt[GLNVshadertexturefootprint]
//
// Contributors:
//   - Pat Brown, NVIDIA
...
// {spirv}/NV/SPVNVshaderimagefootprint.html[SPVNVshaderimagefootprint]
// SPIR-V extension.
...
// Footprint evaluation only supports the CLAMPTOEDGE wrap mode; results are
...
// GLNVshadertexturefootprint shading language extension.
//
...
//
//	uint64t returnedMask = (uint64t(footprint.mask.x) | (uint64_t(footprint.mask.y) << 32));
...
//     VKNVshadersubgrouppartitioned extension or other shader subgroup
//     extensions.
