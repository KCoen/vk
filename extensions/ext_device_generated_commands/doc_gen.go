...
// Package ext_device_generated_commands provides bindings for the VK_EXT_device_generated_commands extension.
// Author: EXT
...
//   - This extension requires VKKHRextendedflags or VKKHR_maintenance5
...
//   - This extension interacts with VKEXTmesh_shader.
//     If the latter extension is not supported, remove the command tokens to
//     initiate EXT mesh tasks drawing in this extension.
//   - This extension interacts with VKKHRraytracingpipeline.
//     If the latter extension is not supported, remove the command tokens to
...
// VKNVdevicegeneratedcommands and
// VKNVdevicegeneratedcommands_compute as well as some new features.
//
...
//     via vkGetBufferDeviceAddress
//   - create a VkIndirectExecutionSetEXT for the ability to change
//     shaders on the device.
//   - create a VkIndirectCommandsLayoutEXT, which lists the
//     VkIndirectCommandsTokenTypeEXT it wants to dynamically execute as
...
//     vkCmdPreprocessGeneratedCommandsEXT, for example on an
//     asynchronous compute queue, or for the purpose of reusing the data in
//     multiple executions.
//   - call vkCmdExecuteGeneratedCommandsEXT to create and execute the
