...
// Package ext_device_memory_report provides bindings for the VK_EXT_device_memory_report extension.
// Author: EXT
...
// consumed by vkCreateGraphicsPipelines.
// It is intended primarily for use by debug tooling rather than for production
// applications.
//
// Issues:
//
// 1) Should this be better expressed as an extension to VKEXTdebug_utils and
...
// flexibility of VKEXTdebug_utils extension.
//
...
// VkInternalAllocationType values.
// The VkDeviceMemoryReportCallbackDataEXT in this extension is
// extensible.
...
//
// VkAllocationCallbacks is described in a section called "Host memory"
...
// same shader heap.
// We are not asking the implementation to report VKOBJECTTYPE_PIPELINE
// along with a VKNULLHANDLE for this bulk allocation.
...
// VKERROROUTOFHOST_MEMORY error when ending a command buffer.
