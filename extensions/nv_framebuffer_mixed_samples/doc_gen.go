...
// Package nv_framebuffer_mixed_samples provides bindings for the VK_NV_framebuffer_mixed_samples extension.
// Author: NV
...
// rendering (similar to the OpenGL GLNVpath_rendering extension).
