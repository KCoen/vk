...
// Package khr_surface provides bindings for the VK_KHR_surface extension.
// Author: KHR
...
// Description:
//
// The VKKHRsurface extension is an instance extension.
...
// VKKHRswapchain (i.e. device extension) and being dependent on
// VkDevice?
//
// RESOLVED:
...
// Many cases can be resolved by a Valid Usage statement.
// The following extensible queries are also available to allow additional
// input parameters:
//
...
//     VKKHRswapchain with the platform description table in this spec.
//
...
//
//   - Fixed the value of VKSURFACEPLATFORMINFOTYPESUPPORTEDKHR.
//
...
//     James Jones)
//
//   - Moved the surface transform enums here from VKWSIswapchain so they
//     could be reused by VKWSIdisplay.
//
...
//
//   - Renamed from VKEXTKHRswapchain to VKEXTKHRsurface.
//
//   - Revision 20, 2015-09-30 (Jeff Vigil)
//
//   - Add error result VKERRORSURFACELOSTKHR.
//
...
//
//   - Renamed from VKEXTKHRsurface to VKKHR_surface.
//
...
//
//   - Moved VKERRORNATIVEWINDOWINUSEKHR from the VKKHRandroid_surface
//     to the VKKHRsurface extension.
//
