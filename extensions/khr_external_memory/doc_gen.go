...
// Package khr_external_memory provides bindings for the VK_KHR_external_memory extension.
// Author: KHR
...
//   - Interacts with VKKHRdedicated_allocation.
//   - Interacts with VKNVdedicated_allocation.
//
// Contributors:
...
// VkPhysicalDeviceProperties::pname:driverVersion field can be used to
// identify compatible devices across processes, drivers, and APIs.
// VkPhysicalDeviceProperties::pname:pipelineCacheUUID is not sufficient
...
//   - A new bit in VkAccessFlags that can be set to indicate an
//     "external" access.
...
// Additionally, the API already includes VKACCESSMEMORYREADBIT and
// VKACCESSMEMORYWRITEBIT which appear to be intended for this
// purpose.
// However, there is no obvious pipeline stage that would correspond to an
// external access, and therefore no clear way to use
// VKACCESSMEMORYREADBIT or VKACCESSMEMORYWRITEBIT.
...
// family index.
// Reusing VKQUEUEFAMILY_IGNORED would have left it unclear how to
...
// transition of
// VKQUEUEFAMILYIGNORED{nbsp}->{nbsp}VKQUEUEFAMILYIGNORED.
