...
// Package nv_external_memory_capabilities provides bindings for the VK_NV_external_memory_capabilities extension.
// Author: NV
...
//
// 2) Does the VkExternalImageFormatPropertiesNV structure need to
