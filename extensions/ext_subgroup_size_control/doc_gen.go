...
// Package ext_subgroup_size_control provides bindings for the VK_EXT_subgroup_size_control extension.
// Author: EXT
...
//
//   - Add the missing VkPhysicalDeviceSubgroupSizeControlFeaturesEXT
