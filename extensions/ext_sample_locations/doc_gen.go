...
// Package ext_sample_locations provides bindings for the VK_EXT_sample_locations extension.
// Author: AMD
...
// To accommodate this, instances of the VkSampleLocationsInfoEXT
// structure can: be specified for each situation where an explicit or
// automatic layout transition has to take place.
// VkSampleLocationsInfoEXT can: be chained from
// VkImageMemoryBarrier structures to provide sample locations for layout
// transitions performed by vkCmdWaitEvents and
// vkCmdPipelineBarrier calls, and
