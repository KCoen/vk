...
// Package qcom_render_pass_transform provides bindings for the VK_QCOM_render_pass_transform extension.
// Author: QCOM
...
//   - This extension interacts with VKKHRfragmentshadingrate
//   - This extension interacts with VKQCOMtile_properties
//
// Contributors:
...
//     VkSwapchainCreateInfoKHR::pname:preTransform equal to the
//     currentTransform as returned by
//     vkGetPhysicalDeviceSurfaceCapabilitiesKHR.
//
// The following is changed with this extension:
//
//   - At vkCmdBeginRenderPass, the application provides extension struct
//     VkRenderPassTransformBeginInfoQCOM specifying the render pass
//     transform parameters.
//   - At vkBeginCommandBuffer for secondary command buffers, the
//     application provides extension struct
//     VkCommandBufferInheritanceRenderPassTransformInfoQCOM specifying
...
//   - If this extension is used with VKQCOMtile_properties, then
//     vkGetFramebufferTilePropertiesQCOM and
//     vkGetDynamicRenderingTilePropertiesQCOM return tile properties in
//     the rotated coordinate space.
//
// Issues:
//
// 1) Some early Adreno drivers (October 2019 through March 2020) advertised
// support for this extension but expected VKSTRUCTURETYPE values different
// from those in the vulkan headers.
// To cover all Adreno devices on the market, applications need to detect the
// driver version and use the appropriate VKSTRUCTURETYPE values from the
// table below.
//
...
// 512.469.0, then simply use the VKSTRUCTURETYPE values as defined in
// vulkan_core.h.
// If the version is less than or equal to 512.468.0, then use the alternate
// values for the two VKSTRUCTURETYPEs in the table below.
//
// .Adreno Driver Requirements
// |====
// |    2+| Adreno Driver Version
// |                      | 512.468.0 and earlier  | 512.469.0 and later
// |VKSTRUCTURETYPE RENDERPASSTRANSFORMBEGININFOQCOM                     | 1000282000 | 1000282001
// |VKSTRUCTURETYPE COMMANDBUFFERINHERITANCERENDERPASSTRANSFORMINFOQCOM| 1000282001 | 1000282000
// |====
//
...
//
// 3) How does this extension interact with VKEXTfragmentdensitymap?
//
...
//
// We considered names such as "rotatedrendering", "prerotation" and
// others.
...
//
// RESOLVED The name "renderpasstransform" seems like the most accurate
// description of the introduced functionality.
//
// 5) How does this extension interact with VKKHRfragmentshadingrate?
//
// RESOLVED:
...
// coordinate system.
//
// The set of supported shading rates may:
// be different per transform.
// Supported rates queried from
// vkGetPhysicalDeviceFragmentShadingRatesKHR are in the native (rotated)
// coordinate system.
...
//   - Adds interactions with VKKHRfragmentshadingrate
//   - Revision 3, 2022-07-11 (Arpit Agarwal)
//   - Adds interactions with VKQCOMtile_properties
//   - Revision 4, 2023-12-13 (Matthew Netsch)
//   - Relax dependencies on VKKHRsurface and VKKHRswapchain
