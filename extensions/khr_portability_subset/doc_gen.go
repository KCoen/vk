...
// Package khr_portability_subset provides bindings for the VK_KHR_portability_subset extension.
// Author: KHR
...
// Description:
//
// The VKKHRportability_subset extension allows a non-conformant
